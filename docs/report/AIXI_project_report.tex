...
\begin{itemize}
    \item \textbf{AIXI} \todo{Fill this Similar to CTW. Arie/Elliot}
    \item \textbf{MCTS} \todo{Fill this Similar to CTW Arie/Elliot}
    \item \textbf{CTW}\\
...
\todo{I would like a line or two in each experiment page discussing the results, i.e. analysing the graph.}
...
\end{tabular}
 ...
 \begin{figure}[h]
 \centering
%    \includegraphics[width=9.3cm]{CrossDom}
\end{figure}
