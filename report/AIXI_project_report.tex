...
\item Some environments were not consistent with (Veness et al. 2011)
...
\section{Future Work}
  ...
  Mentioned in \cite{Ven11}, the set up need not be in base 2. In fact, if base 3 was used then the observation space $|\mathcal{O}|$ of tictactoe would be reduced from $2^{18}=262144$ to $3^9 = 19683$.
  ...
  Lastly, an enhancement may come from using Context Tree Switching instead of Context Tree Weighting. Context Tree Switching \cite{Ven12} has shown to have consistent improvement over Context Tree Weighting
